...
- Publishes a map + list view in a static site (`docs/`)
...
- `docs/app.js`: frontend logic (map, filters, stats)
...
## Deploy in a weekend (GitHub Pages)
...
- WV511 records are official roadway delay events but not all are crashes/fatal incidents.
...
- Add a timeline chart and county-level aggregation.
